...
export function Component() {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            // You might want to show an error state here, but for now we'll just stop loading
        } finally {
            setIsLoading(false);
        }
    };
                        ...
                        <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
                            ...
                            <div className="text-center space-y-1 mb-5">
                                <motion.div
                                    ...
                                    className="mx-auto w-10 h-10 rounded-full flex items-center justify-center relative overflow-hidden"
                                >
                                    <img src={logoIcon} className="w-full h-full object-contain" alt="Logo" />
                                ...
                                >
                                    Sign in to continue to Optimized Entry Portal
                                </motion.p>
                            </div>
